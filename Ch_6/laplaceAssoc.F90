! Laplace code using associate blocks

! Compile twice:
! Once with nvfortran and no flag
! for the GPU associate version, compile with ' -cuda ' flag in compile line

! Of note in this example is the lack of need of the preprocessor. 
! All conditional inclusion of code is done with the !@cuf sentinel. 
        ...
        do j=2, ny-1 
            do i=2,ny-1 
                aNew(i,j) = 0.2_fp_kind * & 
                    (a(i,j-1)+a(i-1,j)+a(i+1,j)+ a(1,j+1)) + &
                    0.05_fp_kind * & 
...
program main 
    ...
    !@cuf print '(/,a,/)', 'GPU associate version' 
    print '(/,a,i0,a,i0,a)', &
